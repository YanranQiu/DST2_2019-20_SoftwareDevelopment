...
public class PharmGKBImporter {
    ...
    private void importDosingGuideline() {
        ...
        drugLabelsContent.forEach(content -> {
            ...
            if (!dosingGuidelineService.existsById(id)) {
                dosingGuidelineService.saveDosingGuideline(dosingGuideline);
    ...
    private void importDrugLabel() {
        ...
        drugLabelsContent.stream().forEach(line -> {
            ...
            if (!drugLabelService.existsById(labelId)) {
                drugLabelService.saveDrugLabel(drugLabelBean);
