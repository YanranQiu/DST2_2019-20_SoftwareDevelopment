...
public class DosingGuidelinedaoImpl extends BaseDao implements IDosingGuidelinedao {

    private static final Logger log = LoggerFactory.getLogger(DosingGuidelinedaoImpl.class);
